...
@XmlRootElement(name = "GetPersonInformationByDni")
public class GetPersonInformationByDni {

    @XmlElementRef(name = "dni", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
