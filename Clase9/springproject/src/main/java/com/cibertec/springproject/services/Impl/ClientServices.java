...
import com.cibertec.springproject.client.*;
import com.cibertec.springproject.configSOA.ReniecClient;
...
public class ClientServices  implements IClientServices {
    ...
    public ClientServices(
        ...
        this._reniecClient=reniecClient;
    }
    ...
    @Override
    public PersonaModel GetClientByDNI(String dni) {
        return _reniecClient.getPersonByDni(dni);
    }
}
